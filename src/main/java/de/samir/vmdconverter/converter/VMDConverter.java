...
public class VMDConverter {
    ...
    public static void convertVideoMP4(String inputFilePath, String outputFilePath) {
        ...
        public static void convertVideoH264(String inputFilePath, String outputFilePath) {
        String output_file = outputFilePath + File.separator + AppController.getFilename() + ".h264";

        String command = String.format("ffmpeg -i %s -vn -codec:a aac -qscale:a 2 %s", inputFilePath, output_file);
    ...
    public static void convertAudioMP3(String inputFilePath, String outputFilePath) {
        ...
        public static void convertAudioOGG(String inputFilePath, String outputFilePath) {
        String output_file = outputFilePath + File.separator + AppController.getFilename() + ".mp3";

        String command = String.format("ffmpeg -i  %s -vn -codec:a libvorbis -qscale:a 2 %s", inputFilePath, output_file);
